...
A default public API key is configured but you should create an account on [OpenWeatherMap](https://openweathermap.org/), create your API key and then replace key in `public/parameters.json` .
